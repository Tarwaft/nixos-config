{
  programs.starship = {
    ...
    settings = {
      ...
      username = {
        show_always = true;
        style_user = "bg:color_bg4 fg:color_textblue";
        style_root = "bg:color_bg4 fg:color_red";
        format = "[ $user ]($style)";
      };

      directory = {
        style = "fg:color_fg0 bg:color_lightblue";
        format = "[ $path ]($style)";
        truncation_length = 3;
        truncation_symbol = "…/";
        substitutions = {
